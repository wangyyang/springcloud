...
public class CacheKeyConstants {
    ...
    public static final String USER_VERIFY_WECHAT_CODE_KEY = "users:wechat:user_verify_code:";
    ...
    //聊天信息
    public static final String IM_CHAT_RECORDS_KEY="im:chat_records:";
    /**
     * 聊天信息过期存储到服务器中
     */
    public static final String IM_CHAT_RECORDS_BAK_KEY="im:chat_records:bak:@";
    /**
     * 职位招聘结束
     */
